...
declare const SvgActionAdd: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$W) => JSX.Element;

interface SVGRProps$V {
    title?: string;
    titleId?: string;
}
declare const SvgActionArchive1: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$V) => JSX.Element;

interface SVGRProps$U {
    title?: string;
    titleId?: string;
}
declare const SvgActionArchive2: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$U) => JSX.Element;

interface SVGRProps$T {
    title?: string;
    titleId?: string;
}
declare const SvgActionBarchart: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$T) => JSX.Element;

interface SVGRProps$S {
    title?: string;
    titleId?: string;
}
declare const SvgActionBulletedList: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$S) => JSX.Element;

interface SVGRProps$R {
    title?: string;
    titleId?: string;
}
declare const SvgActionClose: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$R) => JSX.Element;

interface SVGRProps$Q {
    title?: string;
    titleId?: string;
}
declare const SvgActionDownload: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$Q) => JSX.Element;

interface SVGRProps$P {
    title?: string;
    titleId?: string;
}
declare const SvgActionEmail: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$P) => JSX.Element;

interface SVGRProps$O {
    title?: string;
    titleId?: string;
}
declare const SvgActionFilter1: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$O) => JSX.Element;

interface SVGRProps$N {
    title?: string;
    titleId?: string;
}
declare const SvgActionFilter2: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$N) => JSX.Element;

interface SVGRProps$M {
    title?: string;
    titleId?: string;
}
declare const SvgActionHide: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$M) => JSX.Element;

interface SVGRProps$L {
    title?: string;
    titleId?: string;
}
declare const SvgActionInfo: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$L) => JSX.Element;

interface SVGRProps$K {
    title?: string;
    titleId?: string;
}
declare const SvgActionMenu: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$K) => JSX.Element;

interface SVGRProps$J {
    title?: string;
    titleId?: string;
}
declare const SvgActionMore: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$J) => JSX.Element;

interface SVGRProps$I {
    title?: string;
    titleId?: string;
}
declare const SvgActionMove: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$I) => JSX.Element;

interface SVGRProps$H {
    title?: string;
    titleId?: string;
}
declare const SvgActionNumberedList: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$H) => JSX.Element;

interface SVGRProps$G {
    title?: string;
    titleId?: string;
}
declare const SvgActionRedirectOut: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$G) => JSX.Element;

interface SVGRProps$F {
    title?: string;
    titleId?: string;
}
declare const SvgActionRefresh1: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$F) => JSX.Element;

interface SVGRProps$E {
    title?: string;
    titleId?: string;
}
declare const SvgActionRefresh2: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$E) => JSX.Element;

interface SVGRProps$D {
    title?: string;
    titleId?: string;
}
declare const SvgActionSearch: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$D) => JSX.Element;

interface SVGRProps$C {
    title?: string;
    titleId?: string;
}
declare const SvgActionShow: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$C) => JSX.Element;

interface SVGRProps$B {
    title?: string;
    titleId?: string;
}
declare const SvgActionSortList: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$B) => JSX.Element;

interface SVGRProps$A {
    title?: string;
    titleId?: string;
}
declare const SvgActionTrash: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$A) => JSX.Element;

interface SVGRProps$z {
    title?: string;
    titleId?: string;
}
declare const SvgActionUpload: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$z) => JSX.Element;

interface SVGRProps$y {
    title?: string;
    titleId?: string;
}
declare const SvgDjLogoStandardSize: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$y) => JSX.Element;

interface SVGRProps$x {
    title?: string;
    titleId?: string;
}
declare const SvgIconAdmin: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$x) => JSX.Element;

interface SVGRProps$w {
    title?: string;
    titleId?: string;
}
declare const SvgIconAnalytics: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$w) => JSX.Element;

interface SVGRProps$v {
    title?: string;
    titleId?: string;
}
declare const SvgIconAttribution: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$v) => JSX.Element;

interface SVGRProps$u {
    title?: string;
    titleId?: string;
}
declare const SvgIconBookmark: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$u) => JSX.Element;

interface SVGRProps$t {
    title?: string;
    titleId?: string;
}
declare const SvgIconCompetitors: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$t) => JSX.Element;
...
declare const SvgIconCompetitorsSwords: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$r) => JSX.Element;

interface SVGRProps$q {
    title?: string;
    titleId?: string;
}
declare const SvgIconDjUniversity: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$q) => JSX.Element;

interface SVGRProps$p {
    title?: string;
    titleId?: string;
}
declare const SvgIconFileTicket: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$p) => JSX.Element;

interface SVGRProps$o {
    title?: string;
    titleId?: string;
}
declare const SvgIconGroups: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$o) => JSX.Element;

interface SVGRProps$n {
    title?: string;
    titleId?: string;
}
declare const SvgIconHelpCenter: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$n) => JSX.Element;

interface SVGRProps$m {
    title?: string;
    titleId?: string;
}
declare const SvgIconHelpCircle: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$m) => JSX.Element;

interface SVGRProps$l {
    title?: string;
    titleId?: string;
}
declare const SvgIconHome: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$l) => JSX.Element;
...
declare const SvgIconKeywordList: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$j) => JSX.Element;

interface SVGRProps$i {
    title?: string;
    titleId?: string;
}
declare const SvgIconManageContent: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$i) => JSX.Element;

interface SVGRProps$h {
    title?: string;
    titleId?: string;
}
declare const SvgIconManagePillarTopics: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$h) => JSX.Element;
...
declare const SvgIconSubscription: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$d) => JSX.Element;

interface SVGRProps$c {
    title?: string;
    titleId?: string;
}
declare const SvgIconSupport: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$c) => JSX.Element;

interface SVGRProps$b {
    title?: string;
    titleId?: string;
}
declare const SvgIconSinglePillar: ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps$b) => JSX.Element;
