...
const SvgIconResearchAndDiscovery = ({
  title,
  titleId,
  ...props
  ...
  >
    ...
    <g clipPath="url(#IconResearchAndDiscovery_svg__a)">
      <path
    ...
    <defs>
      <clipPath id="IconResearchAndDiscovery_svg__a">
...
export default SvgIconResearchAndDiscovery;
